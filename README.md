...
- Για την επικοινωνία των μετρητών από τις διεργασίες Ρ προς την γονεϊκή χρησιμοποιήθηκαν οι συναρτήσεις return & wait, με τις Ρ να επιστρέφουν τον μετρητή τους μέσω της return και την γονεϊκή να διαβάζει τις τιμές αυτές μέσω της wait. Αυτό φυσικά προσθέτει περιορισμούς στο μέγεθος των τιμών που μπορούν να επιστραφούν, αλλά επιλέχθηκε ως πιο απλός τρόπος για την υλοποίηση της εργασίας.
